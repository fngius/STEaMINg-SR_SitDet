...
public class ConsoleFormatter extends ResultFormatter {
  ...
  public ConsoleFormatter(SWRLRuleEngine ruleEngine, String situationName, String baseUri, OWLOntology ontology, OWLDataFactory factory) {
      ...
      rdfTable.stream().forEach((t) -> {
        ...
        try {
          ruleEngine.createSWRLRule("CauseDetermination",
              "http://semanticweb.org/STEaMINg/ContextOntology-COInd4#Situation-S6(?sit)" + "->  http://semanticweb.org/STEaMINg/ContextOntology-COInd4#hasCause(?sit, http://semanticweb.org/STEaMINg/ContextOntology-COInd4#PollutedFilters) ");
